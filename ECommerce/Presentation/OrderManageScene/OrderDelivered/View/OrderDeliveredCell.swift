...
final class OrderDeliveredCell: UITableViewCell {
    ...
    private var item: OrderDeliveredItemModel?
    
    func fill(with item: OrderDeliveredItemModel) {
        self.item = item
        ...
        guard let orderIdLabel = orderIdLabel,
            ...
            print("⚠️ [OrderDeliveredCell] Outlets chưa được kết nối trong Storyboard. Vui lòng kiểm tra lại.")
            return
        }
